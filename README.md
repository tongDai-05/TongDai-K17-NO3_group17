...
1. **Sách (Book)**
   - Lưu trữ thông tin của sách, bao gồm: tên, mã sách, tác giả và trạng thái sách.
   ...
   **Thuộc tính**
   ...
   - title(Tên sách)
   - author(Tên tác giả)
   - borrowed(Trạng thái mượn sách)
2. **Người dùng (User)**
   - Lưu trữ thông tin của người dùng, bao gồm: tên, mã người dùng, địa chỉ.
...
2. **sơ đồ class diagam**
 
   <img src="img/classdiagram.jpg">
   
3. **sơ đồ mượn trả sách**
